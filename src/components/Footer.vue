<template>
  <footer class="d-flex flex-items-center border-top px-3 py-6 bg-gray-light text-gray-light f6"
    :style="{ 'margin-top': 'auto' }"
    role="contentinfo">
    <span class="mr-2">© 2021 Material-Icons-Search</span>
    <span class="mr-3">
      Released under the
      <a href="https://opensource.org/licenses/MIT" target="_blank" rel="noopener noreferrer" class="text-gray-light">
        MIT License
      </a>
    </span>
    <a href="https://github.com/underground/material-icons-search" target="_blank" rel="noopener noreferrer"
      class="mr-0 text-gray-light"
